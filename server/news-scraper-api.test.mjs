  ...
  try {
    ...
    const missingNewsIdResponse = await fetch(
      `${testServer.baseUrl}/api/news`,
      {
        ...
        body: JSON.stringify({
          ...
          origin: "Test",
          url: "https://example.com/news/missing-id",
    ...
    const firstCreateResponse = await fetch(`${testServer.baseUrl}/api/news`, {
      ...
      body: JSON.stringify({
        ...
        origin: "Test",
        url: "https://example.com/news/first-unique-item",
        timestamp: new Date().toISOString(),
        favorite: false,
      }),
    });
    ...
    const duplicateNewsIdResponse = await fetch(
      `${testServer.baseUrl}/api/news`,
      {
        ...
        body: JSON.stringify({
          ...
          origin: "Test",
          url: "https://example.com/news/duplicate-unique-item",
          timestamp: new Date().toISOString(),
          favorite: false,
        }),
      },
  ...
  try {
    const createdNewsResponse = await fetch(`${testServer.baseUrl}/api/news`, {
      ...
      body: JSON.stringify({
        ...
        origin: "Test",
        url: "https://example.com/news/rag-default",
        timestamp: new Date().toISOString(),
        favorite: false,
      }),
    });
...
test("news API returns all profile-scoped rows even when roles are configured", async () => {
  ...
  try {
    ...
    await repository.createNewsItem({
      ...
      url: "https://example.com/cto-relevant",
      timestamp: new Date().toISOString(),
      favorite: false,
    });
    ...
    await repository.createNewsItem({
      ...
      url: "https://example.com/not-cto-relevant",
      timestamp: new Date().toISOString(),
      favorite: false,
    });
